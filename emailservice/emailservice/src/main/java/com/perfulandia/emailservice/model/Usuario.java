 ...
 * se utiliza para personalizar emails de confirmación de compra.
 * Se incluye en las notificaciones para dirigirse al cliente
 * por su nombre y enviar el email a la dirección correcta.
 * 
 * Campos obligatorios:
...
public class Usuario {
     ...
     * y se utiliza para personalizar los emails dirigidos
     * al cliente.
     * 
     ...
     * enviarán las notificaciones y confirmaciones.
     * 
